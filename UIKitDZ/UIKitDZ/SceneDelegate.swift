...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        // Навигация
        let editTextNavController = UINavigationController(rootViewController: editTextVC)
        let booksNavController = UINavigationController(rootViewController: booksVC)
        
        let tabBarVC = UITabBarController()
        tabBarVC.setViewControllers([editTextNavController, booksNavController], animated: true)
